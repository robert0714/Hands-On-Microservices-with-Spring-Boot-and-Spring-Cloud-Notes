...
[for istio 1.5.x](https://istio.io/latest/news/releases/1.5.x/announcing-1.5.10/)[k8s1.15-](https://github.com/kubernetes/kubernetes/blob/master/CHANGELOG/CHANGELOG-1.15.md)
```
...
```
minikube -p lab  start --memory=10240mb --cpus=4 --disk-size=30g 
```
